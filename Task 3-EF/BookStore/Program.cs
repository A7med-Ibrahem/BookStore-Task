...
var queries = new BookStoreQueries(context);
...
while (true)
{
    ...
    Console.WriteLine("║  10. Books with Details (EF)      ║");
    Console.WriteLine("║  11. Top 5 Best-Selling (EF)      ║");
    Console.WriteLine("║  12. Customers & Purchases (EF)   ║");
    Console.WriteLine("║  13. Categories > 5 Books (EF)    ║");
    Console.WriteLine("║  14. Books Above Average (EF)     ║");
    Console.WriteLine("║  15. Customers No Purchase (EF)   ║");
    Console.WriteLine("║  16. Revenue by Month (EF)        ║");
    Console.WriteLine("║  17. Search Books (EF)            ║");
    Console.WriteLine("║  18. Pagination (EF)              ║");
    Console.WriteLine("║  19. Add/Update/Delete (EF)       ║");
    ...
    switch (choice)
    {
        ...
        case "9":
            ...
            break;
        case "10":
            queries.ListBooksWithDetails();
            break;
        case "11":
            queries.TopBestSellingBooks();
            break;
        case "12":
            queries.CustomersWithPurchaseCount();
            break;
        case "13":
            queries.CategoriesWithMoreThan5Books();
            break;
        case "14":
            queries.BooksAboveAveragePrice();
            break;
        case "15":
            queries.CustomersWithNoPurchases();
            break;
        case "16":
            queries.RevenueByMonth();
            break;
        case "17":
            Console.Write("Enter keyword: ");
            var keyword = Console.ReadLine() ?? "";
            queries.SearchBooks(keyword);
            break;
        case "18":
            ...
            queries.GetBooksPaged(page, size);
            break;
        case "19":
            queries.AddUpdateDelete();
            break;
        case "0":
...
void AddBook(BookStoreService service)
{
    ...
    switch (type)
    {
        case "1":
            ...
            service.AddBook(new PaperbackBook(title, author, category, price, stock, pages));
            break;
        case "2":
            Console.Write("File Format (PDF/EPUB): ");
            var format = Console.ReadLine() ?? "PDF";
            service.AddBook(new EBook(title, author, category, price, stock, format));
            break;
        case "3":
            ...
            service.AddBook(new AudioBook(title, author, category, price, stock, narrator, duration));
            break;
        default:
