...
namespace BookStoreApp.Services
{
    public class BookStoreService
    {
        ...
        public void RegisterCustomer(string fullName, string email, string city)
        {
            ...
            var customer = new Customer(_customerIdCounter++, fullName, email, city);
        ...
        public void MakePurchase(int customerId, List<(int bookId, int quantity)> items)
        {
            ...
            var purchase = new Purchase(_purchaseIdCounter++, customer);
            ...
            foreach (var (bookId, quantity) in items)
            {
                ...
                book.Stock -= quantity;
                purchase.Items.Add(new PurchaseItem(book, quantity));
